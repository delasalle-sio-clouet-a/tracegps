...
namespace TraceGPS
{
    public class PasserelleServicesWebXML : PasserelleXML
    {
        ...
        private static String _adresseHebergeur = "http://localhost/ws-php-brault/tracegps/api/";
        ...
        //    mdp : le mot de passe hashé en sha1
        //    lesUtilisateurs : collection (vide) à remplir à partir des données fournies par le service web
        public static String getLesUtilisateursQueJautorise(String pseudo, String mdpSha1, ref ArrayList lesUtilisateurs)
        {
            String reponse = "";
            try
            {	// création d'un nouveau document XML à partir de l'URL du service web et des paramètres
        ...
        //    mdp : le mot de passe hashé en sha1
        //    lesUtilisateurs : collection (vide) à remplir à partir des données fournies par le service web
        public static String getLesUtilisateursQuiMautorisent(String pseudo, String mdpSha1, ref ArrayList lesUtilisateurs)
        {
            String reponse = "";
            try
            {	// création d'un nouveau document XML à partir de l'URL du service web et des paramètres
        ...
        public static String getLesParcoursDunUtilisateur(String pseudo, String mdpSha1, String pseudoConsulte, ref ArrayList lesTraces)
        {
            String reponse = "";
            try
            {	// création d'un nouveau document XML à partir de l'URL du service web et des paramètres
                ...
                while (leDocument.ReadToFollowing("trace"))
                {
                    ...
                    DateTime uneDateHeureFin;
                    leDocument.ReadToFollowing("dateHeureFin"); leDocument.Read();
                    if (string.IsNullOrWhiteSpace(leDocument.Value))
                        uneDateHeureFin = DateTime.MinValue;
                    else
                        uneDateHeureFin = Convert.ToDateTime(leDocument.Value.ToString());
                ...
                } // continue au noeud suivant de type <trace>
        ...
        public static String getUnParcoursEtSesPoints(String pseudo, String mdpSha1, int idTrace, ref Trace laTrace)
        {
            String reponse = "";
            try
            {	// création d'un nouveau document XML à partir de l'URL du service web et des paramètres
                ...
                // vider d'abord la collection avant de la remplir
                ArrayList lesPointsDeTrace = new ArrayList();

                leDocument.ReadToFollowing("Trace");
                ...
                // crée un objet Utilisateur
                laTrace = new Trace(unId, uneDateHeureDebut, uneDateHeureFin, terminee, unIdUtilisateur);


                while (leDocument.ReadToFollowing("lesPoints"))
                {
                    // parcours de la liste des noeuds <trace> et ajout dans la collection lesTraces
                    while (leDocument.ReadToFollowing("point"))
                    {
                        ...
                        // parcours des balises intérieures d'un utilisateur
                        leDocument.ReadToFollowing("id"); leDocument.Read();
                        unId = Convert.ToInt32(leDocument.Value);
                        ...
                        // crée un objet Utilisateur
                        PointDeTrace unPointDeTrace = new PointDeTrace(uneLatitude, uneLongitude, uneAltitude, uneDateHeure, unRythmeCardio);
        ...
        public static String demarrerEnregistrementParcours(String pseudo, String mdpSha1, ref Trace laTrace)
        {
            String reponse = "";
            try
            {	// création d'un nouveau document XML à partir de l'URL du service web et des paramètres
                ...
                while (leDocument.ReadToFollowing("trace"))
                {
                    ...
                    leDocument.ReadToFollowing("terminee"); leDocument.Read();
                    bool terminee = Convert.ToBoolean(leDocument.Value.ToString());

                    leDocument.ReadToFollowing("dateHeureFin"); leDocument.Read();
                    DateTime uneDateHeureFin = Convert.ToDateTime(leDocument.Value.ToString());

                    leDocument.ReadToFollowing("distance"); leDocument.Read();
                    double uneDistance = Convert.ToDouble(leDocument.Value);

                    leDocument.ReadToFollowing("idUtilisateur"); leDocument.Read();
                    int unIdUtilisateur = Convert.ToInt32(leDocument.Value);

                    // crée un objet Utilisateur
                    laTrace = new Trace(unId, uneDateHeureDebut, uneDateHeureFin, terminee, unIdUtilisateur, uneDistance);
        ...
        public static String envoyerPosition(String pseudo, String mdpSha1, ref PointDeTrace lePoint)
        {
            String reponse = "";
            try
            {	// création d'un nouveau document XML à partir de l'URL du service web et des paramètres
                ...
                urlDuServiceWeb += "&dateHeure=" + lePoint.getDateHeure().ToString();
                ...
                while (leDocument.ReadToFollowing("id"))
                {
                    leDocument.Read();
                    lePoint.setId(Convert.ToInt32(leDocument.Value));
                }
