...
namespace TraceGPS
{
    public class TestPasserelleServicesWebXML
    {
        static void Main()
        {
            ...
            //lesUtilisateurs = new ArrayList();
            //msg = PasserelleServicesWebXML.getLesUtilisateursQueJautorise("indigo", Outils.sha1("mdputilisateur"), ref lesUtilisateurs);
            //// affichage de la réponse
            ...
            //lesUtilisateurs = new ArrayList();
            //msg = PasserelleServicesWebXML.getLesUtilisateursQuiMautorisent("juno", Outils.sha1("mdputilisateur"), ref lesUtilisateurs);
            //// affichage de la réponse
            ...
            msg = PasserelleServicesWebXML.envoyerPosition("europa", Outils.sha1("mdputilisateurrrrrr"), ref lePoint);
            // Erreur : authentification incorrecte.
            ...
            msg = PasserelleServicesWebXML.envoyerPosition("europa", Outils.sha1("mdputilisateur"), ref lePoint);
            ...
            //msg = PasserelleServicesWebXML.getUnParcoursEtSesPoints("neon", Outils.sha1("mdputilisateur"), 20, ref laTrace);
            //// affichage de la réponse
            ...
            //msg = PasserelleServicesWebXML.getLesParcoursDunUtilisateur("juno", Outils.sha1("mdputilisateur"), "indigo", ref lesTraces);
            //// affichage de la réponse
            ...
            //laTrace = new Trace();
            //msg = PasserelleServicesWebXML.demarrerEnregistrementParcours("europa", Outils.sha1("mdputilisateurrrrrr"), ref laTrace);
            //// Erreur : authentification incorrecte.
            //MessageBox.Show(msg, "Test 15.1", MessageBoxButtons.OK, MessageBoxIcon.Information);
            //laTrace = new Trace();
            //msg = PasserelleServicesWebXML.demarrerEnregistrementParcours("europa", Outils.sha1("mdputilisateur"), ref laTrace);
            //// Trace créée.
